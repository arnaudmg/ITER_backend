...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    whenToCallUs: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts / articles migrated from WordPress';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    legacyUrl: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    > &
      Schema.Attribute.Private;
    migrationMeta: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tableOfContents: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiClientLogoClientLogo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Logos clients homepage';
...
export interface ApiDafExternalisePageDafExternalisePage
  extends Struct.SingleTypeSchema {
  collectionName: 'daf_externalise_pages';
  info: {
    description: 'Page DAF externalise';
    displayName: 'DAF Externalise Page';
    pluralName: 'daf-externalise-pages';
    singularName: 'daf-externalise-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::daf-externalise-page.daf-externalise-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiDafMetierPageDafMetierPage extends Struct.SingleTypeSchema {
  collectionName: 'daf_metier_pages';
  info: {
    description: 'Page DAF metier';
    displayName: 'DAF Metier Page';
    pluralName: 'daf-metier-pages';
    singularName: 'daf-metier-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::daf-metier-page.daf-metier-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDafTempsPartagePageDafTempsPartagePage
  extends Struct.SingleTypeSchema {
  collectionName: 'daf_temps_partage_pages';
  info: {
    description: 'Page DAF temps partage';
    displayName: 'DAF Temps Partage Page';
    pluralName: 'daf-temps-partage-pages';
    singularName: 'daf-temps-partage-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::daf-temps-partage-page.daf-temps-partage-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDafTransitionPageDafTransitionPage
  extends Struct.SingleTypeSchema {
  collectionName: 'daf_transition_pages';
  info: {
    description: 'Page DAF transition';
    displayName: 'DAF Transition Page';
    pluralName: 'daf-transition-pages';
    singularName: 'daf-transition-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aggregateRating: Schema.Attribute.Component<'global.rating', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    logo: Schema.Attribute.Media<'images'>;
    navigation: Schema.Attribute.Component<'global.nav-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGlossaryTermGlossaryTerm
  ...
  info: {
    description: 'Termes du glossaire';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    featuredArticles: Schema.Attribute.Relation<
      ...
      'api::blog-article.blog-article'
    >;
    heroCta: Schema.Attribute.Component<'shared.cta-link', false>;
    heroSubtitle: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    statistics: Schema.Attribute.Component<'homepage.statistic', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valuePropositions: Schema.Attribute.Component<'homepage.value-prop', true>;
    whyChooseItems: Schema.Attribute.Component<'homepage.why-choose', true>;
  };
}

export interface ApiJobMetierJobMetier extends Struct.CollectionTypeSchema {
  collectionName: 'job_metiers';
  info: {
    description: 'Fiches metier';
    displayName: 'Fiche Metier';
    pluralName: 'job-metiers';
    singularName: 'job-metier';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMediaSourceMediaSource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Provenance + dedup index for uploaded media';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    normalizedFilename: Schema.Attribute.String;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    sha256: Schema.Attribute.String & Schema.Attribute.Unique;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic pages migrated from WordPress';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiServiceDetailServiceDetail
  ...
  info: {
    description: 'Pages service individuelles';
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    serviceCards: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-detail.service-detail'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Membres de l'equipe";
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    initialRevenue: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    missionStart: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    relatedTestimonials: Schema.Attribute.Relation<
      'oneToMany',
      'api::testimonial.testimonial'
    >;
    results: Schema.Attribute.Component<'testimonial.result', true>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::job-metier.job-metier': ApiJobMetierJobMetier;
